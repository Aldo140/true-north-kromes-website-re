...
const images: { src: string; alt: string }[] = [
  // 1. FINISHED PRODUCTS ON MODELS - What clients want to see first
  ...
  // 2. POLISHED FRAMEWORKS - Quality showcase
  ...
  // 3. SPECIALTY WORK - Implant bars, mesh trays, grillz
  ...
  // 4. DLYTE POLISHING PROCESS - Technology showcase
  ...
  // 5. 3D PRINTING PROCESS - Manufacturing capability
