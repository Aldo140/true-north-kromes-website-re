  ...
  return (
    <section className="bg-white pt-44 pb-20 lg:pt-52 lg:pb-28">
      <div className="mx-auto max-w-5xl px-5">
        <h1 className="text-center font-sans text-[clamp(1.75rem,3.5vw,2.5rem)] font-light italic text-foreground">
          Blog
        </h1>
        ...
        <div className="mt-14 grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {posts.map((post) => (
            <article key={post.slug} className="group border border-border">
              <div className="aspect-[16/10] w-full bg-[#e8e8e8]">
                <img
              ...
              <div className="p-5">
                ...
                <h2 className="mt-2 font-sans text-lg font-semibold text-foreground">
                  {post.title}
                </h2>
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  {post.excerpt}
                </p>
                <span className="mt-4 inline-block text-sm font-medium text-[#8b7d3c] tracking-wide">
                  Read More
                </span>
              </div>
            </article>
