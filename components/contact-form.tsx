...
export function ContactForm() {
    ...
    return (
      <section className="bg-white py-16 lg:py-24" aria-label="Contact">
        <div className="mx-auto max-w-2xl px-5 text-center">
          <h2 className="font-serif text-[clamp(1.5rem,3vw,2.25rem)] font-normal italic text-foreground">
            Thank You!
          </h2>
  ...
  return (
    <section className="bg-white pt-36 pb-16 lg:pt-44 lg:pb-24" aria-label="Contact Form">
      <div className="mx-auto max-w-2xl px-8 lg:px-16">
        <div className="mb-14">
          <p className="text-xs font-medium uppercase tracking-[0.25em] text-muted-foreground/60">
            Contact
          </p>
          <h2 className="mt-3 font-serif text-[clamp(1.5rem,3vw,2.5rem)] text-foreground">
            Get in Touch
          </h2>
        </div>
