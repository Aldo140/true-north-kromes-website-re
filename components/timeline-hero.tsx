...
export function TimelineHero() {
  ...
  return (
    <section ref={sectionRef} aria-label="A production line you can actually follow" className="relative overflow-hidden bg-paper pt-32 text-ink md:pt-40 lg:pt-44">
      <div className="mx-auto max-w-[1500px] px-5 sm:px-8 lg:px-16">
        ...
        <motion.div style={{ y: copyY }} className="grid gap-10 pb-14 pt-10 lg:grid-cols-12 lg:items-end lg:pb-20 lg:pt-14">
          <h1
            id="timeline-hero-heading-mobile"
            className="text-balance font-sans text-[clamp(2.75rem,12vw,3.25rem)] font-medium leading-[0.92] tracking-[-0.04em] text-ink md:hidden"
          >
            A production line you can actually follow.
          </h1>
          <TypewriterHeadline
            id="timeline-hero-heading"
            text="A production line you can actually follow."
            className="hidden text-balance font-sans text-[clamp(3.25rem,7vw,6rem)] font-medium leading-[0.92] tracking-[-0.04em] text-ink md:block lg:col-span-8"
          />
          <div className="lg:col-span-4 lg:pb-1">
            ...
            <a href="#production-line" className="group mt-7 inline-flex min-h-11 items-center gap-3 border-b border-gold-dim font-mono text-[10px] uppercase tracking-[0.18em] text-ink transition-colors hover:text-gold-dim md:min-h-0 md:pb-2">
              See every handoff
      ...
      <div className="relative mx-auto max-w-[1500px] px-0 sm:px-8 lg:px-16">
        <div className="relative h-[54vh] min-h-[26rem] overflow-hidden bg-ink sm:h-[58vh] lg:min-h-[34rem]">
          ...
          <div className="absolute right-5 top-[5.25rem] grid size-[5.25rem] place-items-center border border-gold/70 bg-ink/75 text-center font-mono text-paper md:hidden" aria-hidden="true">
            <span className="text-[1.65rem] font-medium leading-none text-gold">4</span>
            <span className="-mt-3 text-[8px] uppercase tracking-[0.16em]">business<br />days</span>
          </div>
